                ...
                <div>
                    ...
                    <div className='grid grid-cols-7 mt-8'>
                        ...
                        <svg data-test-id="icon-youtube" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="m11.218 14.641 3.717-2.141-3.717-2.141v4.282Z" fill="#000"></path>
                        </svg>
                        <svg data-test-id="icon-facebook" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M.5 6.5a6 6 0 0 1 6-6h12a6 6 0 0 1 6 6v12a6 6 0 0 1-6 6h-12a6 6 0 0 1-6-6v-12Z" fill="#000"></path>
                            <path d="m17.171 15.969.532-3.469h-3.328v-2.25c0-.95.464-1.875 1.955-1.875h1.514V5.422s-1.374-.234-2.686-.234c-2.742 0-4.533 1.661-4.533 4.668V12.5H7.578v3.469h3.047V24.5h3.75v-8.531h2.796Z" fill="#fff"></path>
                        </svg>
                    </div>
                    <p className='mt-8 font-semibold text-lg'>Get the ultimate shopping experience on voilà.id app</p>
                    <div className='grid grid-cols-3 gap-5 mt-5'>
                        <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fstore%2Fgoogle-playstore.png@webp' alt='googleplay'/>
                        <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fstore%2Fapple-store.png@webp' alt='appstore'/>
                    </div>
                </div>
                <div className='ps-20'>
                ...
                <div>
                    <div className='border-b-[1px] pb-5'>
                        ...
                        <div className='grid grid-cols-4 items-center gap-5'>
                            ...
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fstore%2Ftiktok.png@webp' alt='tiktokshop' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fstore%2Fzalora.png@webp' alt='zalora' />
                        </div>
                    </div>
                    <div className='border-b-[1px] pb-5'>
                        <h1 className='font-bold mb-5 mt-5'>Payment Options</h1>
                        <div className='grid grid-cols-5 items-center gap-5'>
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fbca.png@webp' alt='bca' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fmandiri.png@webp' alt='mandiri' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fbri.png@webp' alt='bri' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fbni.png@webp' alt='bni' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fcimb.png@webp' alt='cimb' />
                            ...
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fmega.png@webp' alt='mega' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fpermata.svg@webp' alt='permata' />
                            ...
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fmayapada-new.png@webp' alt='mayapada' />
                            ...
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fbank%2Fmastercard.png@webp' alt='mastercard' />
                    ...
                    <div className='border-b-[1px] pb-5'>
                        ...
                        <div className='grid grid-cols-4 items-center gap-5'>
                            ...
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fshipping%2Fgosend.png@webp' alt='gosend' />
                            <img src='https://images.voila.id/pr:sharp/rs:fit:128:0/plain/https%3A%2F%2Fvoila.id%2Fstatic%2Fshipping%2Fpaxel.png@webp' alt='paxel' />
                        </div>
                    </div>
                </div>
            </div>
