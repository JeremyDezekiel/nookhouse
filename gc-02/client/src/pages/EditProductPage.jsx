...
function EditProductPage() {
    ...
    useEffect(() => {
        if (!isLoading && product) {
            ...
            setNameLength(product.name.length)
            setDescriptionLenght(product.description.length)
        }
    }, [isLoading, product])
    ...
    return (
        <main>
            <section>
                <h1 className='text-lg lg:text-3xl font-bold px-2 lg:px-0'>Edit Product</h1>
                    ...
                    <div className='border rounded-md p-10 grid gap-10'>
                        ...
                        <div className='grid grid-cols-6'>
                            ...
                            <div className='w-full col-span-4 col-start-3'>
                                <div className={`border py-2 rounded-md ${categoryError && 'border-red-600'}`}>
                                    <select 
                                        className='w-full px-2 text-[#606060] outline-none' 
                                        value={category} 
                        ...
                        <div className='grid grid-cols-6'>
                            ...
                            <div className='w-full col-span-4 col-start-3'>
                                ...
                                <div className='grid lg:flex justify-between text-[#606060]'>
                        ...
                        <div className='grid grid-cols-6'>
                            ...
                            <div className='w-full col-span-4 col-start-3'>
                                <div className={`border flex rounded-md ${priceError && 'border-red-600'}`}>
                                    <h1 className='bg-[#F3F4F5] p-2 rounded-s-md text-gray-400'>Rp</h1>
                                    <input
                                        className='w-full px-2 outline-none peer'
                                        type='number'
