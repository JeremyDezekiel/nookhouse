                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div>
                        <div className='flex gap-5 items-start mb-2'>
                            <h1 className={`${product.discount !== '' ? 'text-3xl line-through' : 'text-4xl'}`}>Rp{product.price.toLocaleString()}</h1>
                            {product.discount && <p className='bg-red-500 px-2 rounded-full'>{product.discount}%</p>}
                        </div>
                    { product.discount && (
